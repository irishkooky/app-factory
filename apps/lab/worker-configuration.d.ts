/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 332948555b4f692ca30c531549dbdc62)
// Runtime types generated with workerd@1.20260701.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	APP_AI_ERA_SKILL_QUIZ: Fetcher /* ai-era-skill-quiz */;
	APP_AKACHAN_PARTY: Fetcher /* akachan-party */;
	APP_AUTH_DEMO: Fetcher /* auth-demo */;
	APP_CASH_FORECAST: Fetcher /* cash-forecast */;
	APP_CONVEX_SHOWCASE: Fetcher /* convex-showcase */;
	APP_GUESTBOOK: Fetcher /* guestbook */;
	APP_HELLO: Fetcher /* hello */;
	APP_LOOP_ENGINEERING_DEMO: Fetcher /* loop-engineering-demo */;
	APP_LOXONIN_REMINDER: Fetcher /* loxonin-reminder */;
	APP_PITCH_BATTLE: Fetcher /* pitch-battle */;
	APP_PITCH_ROULETTE: Fetcher /* pitch-roulette */;
	APP_SALON_BOOKING: Fetcher /* salon-booking */;
	APP_TOKEN_COST_CHECKER: Fetcher /* token-cost-checker */;
	APP_TOKEN_COST_CHECKER_B: Fetcher /* token-cost-checker-b */;
	APP_TOKEN_COST_CHECKER_FABLE_ONLY: Fetcher /* token-cost-checker-fable-only */;
	APP_TOKEN_COST_CHECKER_FABLE_ORCHESTRATION: Fetcher /* token-cost-checker-fable-orchestration */;
	APP_TOKYO_OUTFIT: Fetcher /* tokyo-outfit */;
	APP_TURING_WEREWOLF: Fetcher /* turing-werewolf */;
}
